# power_slash.py – kompletní a syntakticky ověřená verze (2025‑08‑05)
# =====================================================================
# Slash příkazy:
#   /powerenter, /powerplayer, /powertopplayer, /powerplayervsplayer
#   /powerlist, /powererase, /stormsetup, /info
# =====================================================================
...
def _df() -> pd.DataFrame:
    """Načte CSV a převede timestamp – poškozené řádky vyřadí."""
...
class PowerCommands(commands.Cog):
    ...
    async def powerplayer(self, inter: Interaction, player: str):
        ...
        await inter.followup.send(file=discord.File(buf, "progress.png"), ephemeral=True)
    ...
    async def powerplayervsplayer(self, inter: Interaction, player1: str, player2: str, team: str):
        ...
        df = _df(); last = df.sort_values("timestamp").groupby("player", as_index=False).last()
