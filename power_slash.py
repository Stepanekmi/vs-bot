...
class PowerCommands(commands.Cog):
    ...
    @app_commands.command(name="poweradd", description="Zadej sílu týmů ve formátu XX.XX (např. 33.06)")
    @app_commands.describe(tank="Síla tankového týmu", rakety="Síla raketového týmu", mix="Síla smíšeného týmu")
